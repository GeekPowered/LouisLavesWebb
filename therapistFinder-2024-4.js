$(document).ready(function () {
    ...
    const therapists = {
        ...
        danChampoux: {
            q1: ['individual', 'couples'],
            q2: ['anxietyDepression', 'relationship', 'lifeTransitions', 'ptsd', 'mensIssues', 'other', 'spirituality', 'mensIssues', 'health'],
            q3: ['inPerson', 'telehealth', 'noPref'],
            q4: ['male', 'noPref'],
            q5: ['youngAdult', 'adult', 'senior'],
            info: {
                ...
                title: 'LMSW',
                link: '/dan-champoux/',
                image: 'https://uploads-ssl.webflow.com/6331c98293c88392fa71043c/65ae8c3dac266c33a39013fe_Dan-Psych-72071%20(1).jpg'
            }
        },
        stephenJennings: {
            q1: ['individual'],
            q2: ['anxietyDepression', 'relationship', 'lifeTransitions', 'other', 'trauma', 'mensIssues', 'health', 'addiction'],
            q3: ['inPerson', 'telehealth', 'noPref'],
            q4: ['male', 'noPref'],
            q5: ['youngAdult', 'adult', 'senior'],
            info: {
                ...
                title: 'LPC',
                link: '/stephen-jennings/',
                image: 'https://uploads-ssl.webflow.com/6331c98293c88392fa71043c/6675b7b9c5b26236a2e8c16a_stephen%20headshot.jpeg'
            }
        }
